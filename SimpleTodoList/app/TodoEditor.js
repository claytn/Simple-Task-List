...
class TodoListCreator extends Component{
  ...
  createNewTodo(){
    if(this.state.todo === '' && this.state.notes === ''){
      return;
    }

    realm.write(()=>{
      var updatedTodo = this.props.task;
      updatedTodo.text = this.state.todo;
      updatedTodo.notes = this.state.notes;
    });
